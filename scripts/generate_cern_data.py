...
def generate_small_dataset(output_dir: Path):
...
def generate_comprehensive_dataset(output_dir: Path):
    ...
    for material in materials:
        ...
        # Plasma oscillation - 1000 particles, 1000 timesteps
        print(f"  - Plasma oscillation...")
        plasma_traj = plasma_gen.generate(
            n_particles=1000,
            density=1.0,
...
def main():
    ...
    parser.add_argument('--size', type=str, choices=['small', 'comprehensive'], default='small',
                        help='Dataset size: small (100 particles, 50 timesteps) or comprehensive (1000 particles, 1000 timesteps)')
    ...
    if args.size == 'small':
        ...
        generate_small_dataset(output_dir)
    else:
        output_dir = output_base / 'synthetic_comprehensive'
        generate_comprehensive_dataset(output_dir)
